...
export default function BrandLogo({
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`.trim()}>
      <span
        className={`relative flex h-10 w-10 items-center justify-center rounded-[0.95rem] border border-cyan-200/45 bg-[radial-gradient(circle_at_30%_24%,rgba(255,255,255,0.46),rgba(255,255,255,0)_54%),linear-gradient(140deg,rgba(31,75,115,0.22),rgba(31,75,115,0.14)_42%,rgba(176,122,69,0.2)_100%)] shadow-[0_8px_24px_rgba(18,38,58,0.16)] sm:h-11 sm:w-11 sm:rounded-[1.05rem] ${introActive ? "logo-intro-active" : ""}`.trim()}
      >
